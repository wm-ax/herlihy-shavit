...
pub fn dine_starvation_free(duration: u64, num_reports: u64) {
    // each phil has a left and a right can.
    // each time he eats, he knocks over his own cans, and resets the left, right cans of his right, left neighbors
}
